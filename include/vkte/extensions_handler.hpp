...
public:
	...
	void add_extensions(const std::vector<const char*>& requested_extensions);
	bool check_extension_availability(const std::vector<const char*>& available_extensions);
